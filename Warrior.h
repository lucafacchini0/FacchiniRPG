...
public:
    static const stats_t DEFAULT_HP_INCREMENT = 20;
    static const stats_t DEFAULT_MANA_INCREMENT = 10;
    static const stats_t DEFAULT_ATK_INCREMENT = 5;
    static const stats_t DEFAULT_DEFENSE_INCREMENT = 3;
